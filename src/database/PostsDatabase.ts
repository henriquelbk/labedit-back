...
export class PostsDatabase extends BaseDatabase {
  ...
  public getPostsWithCreatorName = async (): Promise<
    PostDBWithCreatorName[]
  > => {
    const postsDB = await BaseDatabase.connection(PostsDatabase.TABLE_POSTS)
      .select(
  ...
  public findLikeDislike = async (
    ...
    const [result] = await BaseDatabase.connection(
      PostsDatabase.TABLE_LIKES_DISLIKES_POSTS
    )
      .select()
      .where({
  ...
  public removeLikeDislike = async (
    ...
    await BaseDatabase.connection(PostsDatabase.TABLE_LIKES_DISLIKES_POSTS)
      .delete()
      .where({
        user_id: likeDislikeDB.user_id,
        post_id: likeDislikeDB.post_id,
